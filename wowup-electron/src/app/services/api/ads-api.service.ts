...
export class AdsApiService {
  ...
  public load(options: AdPageOptions): Promise<void> {
    return this._electronService.invoke(IPC_ADS_LOAD, options);
  }

  public disable(): Promise<void> {
    return this._electronService.invoke(IPC_ADS_DISABLE);
  }

  /** Passing no rect parks the ad view without unloading the ad page. */
  public setBounds(rect?: AdViewRect): Promise<void> {
    return this._electronService.invoke(IPC_ADS_SET_BOUNDS, rect);
  }

  public reload(): Promise<void> {
    return this._electronService.invoke(IPC_ADS_RELOAD);
  }

  public openDevTools(): Promise<void> {
    return this._electronService.invoke(IPC_ADS_OPEN_DEV_TOOLS);
  }

  public showCmp(): Promise<void> {
    return this._electronService.invoke(IPC_ADS_SHOW_CMP);
  }

  public resurfaceCmp(): Promise<void> {
    return this._electronService.invoke(IPC_ADS_RESURFACE_CMP);
  }
}
