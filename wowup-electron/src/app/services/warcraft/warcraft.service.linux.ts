...
const WOW_ARM64_RETAIL_NAME = "Wow-ARM64.exe";
const WOW_ARM64_RETAIL_PTR_NAME = "WowT-ARM64.exe";
const WOW_ARM64_RETAIL_BETA_NAME = "WowB-ARM64.exe";
const WOW_ARM64_CLASSIC_NAME = "WowClassic-arm64.exe";
const WOW_ARM64_CLASSIC_PTR_NAME = "WowClassicT-arm64.exe";
const WOW_ARM64_CLASSIC_BETA_NAME = "WowClassicB-arm64.exe";
...
const WOW_APP_NAMES = [
  ...
  WOW_ARM64_RETAIL_NAME,
  WOW_ARM64_RETAIL_PTR_NAME,
  WOW_ARM64_RETAIL_BETA_NAME,
  WOW_ARM64_CLASSIC_NAME,
  WOW_ARM64_CLASSIC_PTR_NAME,
  WOW_ARM64_CLASSIC_BETA_NAME,
];
