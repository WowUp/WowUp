...
export const IPC_ADS_LOAD = "ads-load";
export const IPC_ADS_DISABLE = "ads-disable";
export const IPC_ADS_SET_BOUNDS = "ads-set-bounds";
export const IPC_ADS_RELOAD = "ads-reload";
export const IPC_ADS_OPEN_DEV_TOOLS = "ads-open-dev-tools";
export const IPC_ADS_SHOW_CMP = "ads-show-cmp";
export const IPC_ADS_RESURFACE_CMP = "ads-resurface-cmp";
export const IPC_ADS_CMP_CLOSE = "ads-cmp-close";
